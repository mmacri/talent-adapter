  ...
  const jobApplications: JobApplication[] = [
    {
      ...
      location: 'Seattle, WA',
      status: 'interview',
      statusDate: '2024-01-20', // Status changed to interview
    ...
    },
    {
      ...
      location: 'San Francisco, CA',
      status: 'applied',
      statusDate: '2024-01-22', // Status changed to applied
    ...
    },
    {
      ...
      location: 'Remote',
      status: 'prospect',
      statusDate: '2024-01-25', // Status set to prospect
      variantId: 'variant-partner-director',
      coverLetterId: '',
    ...
    },
    {
      ...
      status: 'rejected',
      statusDate: '2024-01-18', // Date when rejection was received
      variantId: 'variant-grc-presales',
      coverLetterId: 'cover-letter-1',
    ...
    },
    {
      ...
      status: 'offer',
      statusDate: '2024-02-05', // Date when offer was received
      variantId: 'variant-partner-director',
      coverLetterId: 'cover-letter-1',
